...
Camera keys are at 0, 5, 8, 11, 14, 18, 21 and 24 seconds; chapter boundaries are at 0, 6, 12 and 18 seconds. They deliberately differ so camera moves lead into the process views. The last camera key matches the first. Quintic easing creates soft starts and stops between keys.
