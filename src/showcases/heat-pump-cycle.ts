...
export const showcaseShots: readonly Shot[] = [
  { time: 0, eye: [2.7, 1.22, 3.25], target: [0, 0.57, 0], rotation: -0.22, background: brand.colors.stage, accent: 0xb6eafa },
  { time: 5, eye: [1.7, 1.48, 2.35], target: [0, 0.62, 0], rotation: 0.24, background: brand.colors.stage, accent: 0xb6eafa },
  { time: 8, eye: [1.1, 2.7, 1.8], target: [0, 1.0, 0], rotation: 0.5, background: brand.colors.stageCool, accent: 0x8fd7ef },
  { time: 11, eye: [0.95, 2.75, 1.8], target: [0, 1.0, 0], rotation: 0.5, background: brand.colors.stageCool, accent: 0x8fd7ef },
  { time: 14, eye: [1.25, 0.65, 1.72], target: [0.20, 0.32, 0.20], rotation: -0.12, background: brand.colors.stageWarm, accent: 0xffc79e },
  { time: 18, eye: [1.25, 0.65, 1.72], target: [0.20, 0.32, 0.20], rotation: -0.12, background: brand.colors.stageCool, accent: 0x9bd9ff },
  { time: 21, eye: [1.4, 0.8, 1.95], target: [0.20, 0.36, 0.20], rotation: -0.12, background: brand.colors.stage, accent: 0xb1e7e5 },
  { time: 24, eye: [2.7, 1.22, 3.25], target: [0, 0.57, 0], rotation: -0.22, background: brand.colors.stage, accent: 0xb6eafa },
];
